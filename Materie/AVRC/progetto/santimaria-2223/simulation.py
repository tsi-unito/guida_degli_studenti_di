...
class Simulation:
    ...
    def __init__(self, G, initial_state, state_transition,
            stop_condition=None, name='', communities=False, communitiesAssignement=None, communitiesStartFromSingle=False):
        '''
        ...
        self._initialize(communities=communities, communitiesAssignement=communitiesAssignement,communitiesStartFromSingle=communitiesStartFromSingle)
    ...
    def _initialize(self, communities=False, communitiesAssignement=None, communitiesStartFromSingle=False):
        if self._initial_state:
            if callable(self._initial_state):
                if communities:
                    state = self._initial_state(self.G, communitiesAssignement, communitiesStartFromSingle)
                else:
