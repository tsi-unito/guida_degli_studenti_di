...
\newcommand\mycommfont[1]{\footnotesize\ttfamily\textcolor{cyan}{#1}}
...
\newcommand{\evidence}[1]{\paragraph {\textit{\textcolor{cyan}{#1}}}}
...
{\addvspace{30pt}%
	\begin{tikzpicture}[remember picture, overlay]%
		\draw[fill=cyan,draw=cyan] (-7.3,-.1) rectangle (-0.9,.5);%
		\pgftext[left,x=-3.7cm,y=0.2cm]{\color{white}\Large\sc\bfseries Capitolo\ \thecontentslabel};%
	\end{tikzpicture}\color{cyan}\large\sc\bfseries}%
{}
{}
{\;\titlerule\;\large\sc\bfseries Pagina \thecontentspage
	\begin{tikzpicture}[remember picture, overlay]
		\draw[fill=cyan,draw=cyan] (2pt,0) rectangle (4,0.1pt);
	\end{tikzpicture}}%
...
\renewcommand{\tableofcontents}{%
	\chapter*{%
	  \vspace*{-20\p@}%
	  \begin{tikzpicture}[remember picture, overlay]%
		  \pgftext[right,x=15cm,y=0.2cm]{\color{cyan}\Huge\sc\bfseries \contentsname};%
		  \draw[fill=cyan,draw=cyan] (13,-.75) rectangle (20,1);%
