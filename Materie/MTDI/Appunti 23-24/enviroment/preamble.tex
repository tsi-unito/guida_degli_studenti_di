...
\hypersetup{
	pdftitle={Assignment},
	colorlinks=true, linkcolor=purple,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section]{Lenma}{Obiettivo}
{%
	enhanced,
	breakable,
	colback = mylenmabg,
...
\newcounter{question}[chapter] % Define the 'question' counter to reset every chapter

\makeatletter
\newtcbtheorem[number within=chapter]{question}{Domanda}{
    enhanced,
    breakable,
    colback=white,
    ...
    #1
}{question} % 'question' is the counter name
\@addtoreset{question}{chapter} % Add 'question' to the list of counters reset at each chapter
\makeatother
...
{\addvspace{30pt}%
	\begin{tikzpicture}[remember picture, overlay]%
		\draw[fill=purple,draw=purple] (-7.3,-.1) rectangle (-0.5,.5);%
		\pgftext[left,x=-3.7cm,y=0.2cm]{\color{white}\Large\sc\bfseries Capitolo\ \thecontentslabel};%
	\end{tikzpicture}\color{purple}\large\sc\bfseries}%
{}
{}
{\;\titlerule\;\large\sc\bfseries Pagina \thecontentspage
	\begin{tikzpicture}[remember picture, overlay]
		\draw[fill=purple,draw=purple] (2pt,0) rectangle (4,0.1pt);
	\end{tikzpicture}}%
...
\renewcommand{\tableofcontents}{%
	\chapter*{%
	  \vspace*{-20\p@}%
	  \begin{tikzpicture}[remember picture, overlay]%
		  \pgftext[right,x=15cm,y=0.2cm]{\color{purple}\Huge\sc\bfseries \contentsname};%
		  \draw[fill=purple,draw=purple] (13,-.75) rectangle (20,1);%
